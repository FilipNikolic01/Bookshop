        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BookOrdered_BookId = table.Column<int>(type: "int", nullable: false),
                    BookOrdered_BookTitle = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    BookOrdered_PictureURL = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Price = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
